            ...
            <nav class="sb-sidenav accordion sb-sidenav-five" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a @class(['nav-link', 'active' => isset($menu) && $menu == 'users']) href="{{ route('users.index') }}">
                ...
                <div class="sb-sidenav-footer">
                    <div class="small">Logado: Sergio</div>
                </div>
            </nav>
        </div>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Sergio {{ date('Y') }}</div>
                        <div>
